...
const es = {
  ...
  homeCstBullets: [
    'CRI: El cuerpo físico — 8–12 ciclos/min',
    'Mid-Tide: El cuerpo fluido — 2–3 ciclos/min',
    'Long Tide: El movimiento energético — aprox. 1 ciclo/100 seg.',
  ...
  cranioRhythmsLabel: 'Los tres movimientos',
  cranioRhythmsTitle: 'CRI, Mid-Tide, Long Tide',
  cranioRhythmsSubtitle: 'Cuerpo, fluido y energía',
  ...
  cranioRhythmsTextExtra: 'Mid-Tide es más lento — alrededor de dos ciclos y medio por minuto — y pertenece al cuerpo fluido. Aquí el terapeuta no percibe estructuras sino fuerzas. Es el principio organizador que forma y mantiene la arquitectura del tejido. Long Tide es el más lento: un ciclo en cien segundos. Se experimenta como un movimiento energético universal que trasciende lo individual. Sutherland lo llamó "Breath of Life" — el aliento de la vida, presente antes de la primera respiración pulmonar.',
  cranioRhythmsBullets: [
    'CRI: el cuerpo físico — el ritmo más tangible',
    'Mid-Tide: el cuerpo fluido — el campo que forma el tejido',
    'Long Tide: el movimiento energético — el pulso fundamental de la vida',
